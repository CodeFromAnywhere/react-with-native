export const sdkInterfacePaths = {
  "NamedParameters<typeof getTailwindModules>": "/packages/react-with-native/db/ts-interfaces/namedparameterstypeof-gettailwindmodules.json",
  "NamedParameters<typeof joinClassNames>": "/packages/react-with-native/db/ts-interfaces/namedparameterstypeof-joinclassnames.json",
  "NamedParameters<typeof Svg>": "/packages/react-with-native/db/ts-interfaces/namedparameterstypeof-svg.json",
  "NamedParameters<typeof trimClassName>": "/packages/react-with-native/db/ts-interfaces/namedparameterstypeof-trimclassname.json",
  "NamedParameters<typeof wrapInTextIfNeeded>": "/packages/react-with-native/db/ts-interfaces/namedparameterstypeof-wrapintextifneeded.json",
  "SvgType": "/packages/react-with-native/db/ts-interfaces/svgtype.json",
  "NamedParameters<typeof AlertProvider>": "/packages/react-with-native-alert/db/ts-interfaces/namedparameterstypeof-alertprovider.json",
  "NamedParameters<typeof useAlert>": "/packages/react-with-native-alert/db/ts-interfaces/namedparameterstypeof-usealert.json",
  "MapLocation": "/packages/react-with-native-form-inputs/db/ts-interfaces/maplocation.json",
  "PluginInputType": "/packages/react-with-native-form-inputs/db/ts-interfaces/plugininputtype.json",
  "Suggestion": "/packages/react-with-native-form-inputs/db/ts-interfaces/suggestion.json",
  "ViewPort": "/packages/react-with-native-form-inputs/db/ts-interfaces/viewport.json",
  "NamedParameters<typeof Modal>": "/packages/react-with-native-modal/db/ts-interfaces/namedparameterstypeof-modal.json",
  "NamedParameters<typeof ModalProvider>": "/packages/react-with-native-modal/db/ts-interfaces/namedparameterstypeof-modalprovider.json",
  "NamedParameters<typeof useModal>": "/packages/react-with-native-modal/db/ts-interfaces/namedparameterstypeof-usemodal.json",
  "NamedParameters<typeof useModalState>": "/packages/react-with-native-modal/db/ts-interfaces/namedparameterstypeof-usemodalstate.json",
  "NamedParameters<typeof useNavigation>": "/packages/react-with-native-router/db/ts-interfaces/namedparameterstypeof-usenavigation.json",
  "NamedParameters<typeof useRouter>": "/packages/react-with-native-router/db/ts-interfaces/namedparameterstypeof-userouter.json",
  "ID": "/packages/react-with-native-select/db/ts-interfaces/id.json",
  "NamedParameters<typeof getItem>": "/packages/react-with-native-store/db/ts-interfaces/namedparameterstypeof-getitem.json",
  "NamedParameters<typeof setItem>": "/packages/react-with-native-store/db/ts-interfaces/namedparameterstypeof-setitem.json",
  "CustomUrlStoreConfig": "/packages/use-url-store/db/ts-interfaces/customurlstoreconfig.json",
  "NamedParameters<typeof useCustomUrlStore>": "/packages/use-url-store/db/ts-interfaces/namedparameterstypeof-usecustomurlstore.json",
  "ContextualPrompt": "/modules/markdown/db/ts-interfaces/contextualprompt.json",
  "ContextualPromptsObject": "/modules/ai-functions-node/db/ts-interfaces/contextualpromptsobject.json",
  "FileType": "/modules/filename-conventions/db/ts-interfaces/filetype.json",
  "NamedParameters<typeof controlChatGpt>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-controlchatgpt.json",
  "NamedParameters<typeof controlChatGptCli>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-controlchatgptcli.json",
  "NamedParameters<typeof getContextualPrompt>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-getcontextualprompt.json",
  "NamedParameters<typeof getContextualPromptResults>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-getcontextualpromptresults.json",
  "NamedParameters<typeof getContextualPrompts>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-getcontextualprompts.json",
  "NamedParameters<typeof getContextualPromptsArray>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-getcontextualpromptsarray.json",
  "NamedParameters<typeof getFolderRelativeScopeDbFilePath>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-getfolderrelativescopedbfilepath.json",
  "NamedParameters<typeof processChatGptPrompt>": "/modules/ai-functions-node/db/ts-interfaces/namedparameterstypeof-processchatgptprompt.json",
  ...
  "NamedParameters<typeof getGetApiUrl>": "/modules/api/db/ts-interfaces/namedparameterstypeof-getgetapiurl.json",
  ...
  "NamedParameters<typeof test>": "/modules/rebuild-operation/db/ts-interfaces/namedparameterstypeof-test.json",
  ...
  "NamedParameters<typeof AssetView>": "/modules/asset-view/db/ts-interfaces/namedparameterstypeof-assetview.json",
  ...
  "Authorization": "/modules/peer-types/db/ts-interfaces/authorization.json",
  ...
  "NamedParameters<typeof AuthenticationMethodsCrud>": "/modules/authentication/db/ts-interfaces/namedparameterstypeof-authenticationmethodscrud.json",
  ...
  "BundleMarkdownReaderConfig": "/modules/markdown-reader-functions/db/ts-interfaces/bundlemarkdownreaderconfig.json",
  ...
  "PublicBundleConfig": "/modules/reader-ui/db/ts-interfaces/publicbundleconfig.json",
  ...
  "TsComment": "/modules/code-types/db/ts-interfaces/tscomment.json",
  "TsExport": "/modules/code-types/db/ts-interfaces/tsexport.json",
  ...
  "CommentTypeObject": "/modules/code-types/db/ts-interfaces/commenttypeobject.json",
  ...
  "FolderSummary": "/modules/markdown-parsings/db/ts-interfaces/foldersummary.json",
  "Frontmatter": "/modules/model-types/db/ts-interfaces/frontmatter.json",
  "FunctionClassification": "/modules/code-types/db/ts-interfaces/functionclassification.json",
  "FunctionExecution": "/modules/code-types/db/ts-interfaces/functionexecution.json",
  "FunctionParameter": "/modules/db-crud/db/ts-interfaces/functionparameter.json",
  ...
  "JSONSchema7Type": "/modules/code-types/db/ts-interfaces/jsonschema7type.json",
  ...
  "NamedParameters<typeof abc>": "/modules/code-types/db/ts-interfaces/namedparameterstypeof-abc.json",
  "NamedParameters<typeof getExamples>": "/modules/code-types/db/ts-interfaces/namedparameterstypeof-getexamples.json",
  "NamedParameters<typeof getFunctionExersize>": "/modules/code-types/db/ts-interfaces/namedparameterstypeof-getfunctionexersize.json",
  ...
  "RunEveryPeriodEnum": "/modules/code-types/db/ts-interfaces/runeveryperiodenum.json",
  "Schema": "/modules/schema-util/db/ts-interfaces/schema.json",
  "SimplifiedSchema": "/modules/simplified-schema-form/db/ts-interfaces/simplifiedschema.json",
  "SimplifiedSchemaItem": "/modules/code-types/db/ts-interfaces/simplifiedschemaitem.json",
  "SimplifiedSchemaProperty": "/modules/markdown-parsings/db/ts-interfaces/simplifiedschemaproperty.json",
  "SimplifiedSchemaType": "/modules/name-conventions/db/ts-interfaces/simplifiedschematype.json",
  "SizeSummary": "/modules/code-types/db/ts-interfaces/sizesummary.json",
  "TsConfig": "/modules/get-path/db/ts-interfaces/tsconfig.json",
  "TsFunctionFrontmatterConfig": "/modules/code-types/db/ts-interfaces/tsfunctionfrontmatterconfig.json",
  "TsFunctionIndex": "/modules/code-types/db/ts-interfaces/tsfunctionindex.json",
  "TsIndexModelType": "/modules/model-types/db/ts-interfaces/tsindexmodeltype.json",
  "TypeCoverage": "/modules/code-types/db/ts-interfaces/typecoverage.json",
  "TypeInfo": "/modules/code-types/db/ts-interfaces/typeinfo.json",
  ...
  "CopyPair": "/modules/collect-static-assets/db/ts-interfaces/copypair.json",
  "NamedParameters<typeof copyCopyPairs>": "/modules/collect-static-assets/db/ts-interfaces/namedparameterstypeof-copycopypairs.json",
  "NamedParameters<typeof copyReaderStaticAssets>": "/modules/collect-static-assets/db/ts-interfaces/namedparameterstypeof-copyreaderstaticassets.json",
  "NamedParameters<typeof findReaderStaticAssets>": "/modules/collect-static-assets/db/ts-interfaces/namedparameterstypeof-findreaderstaticassets.json",
  "NamedParameters<typeof findStaticAssets>": "/modules/collect-static-assets/db/ts-interfaces/namedparameterstypeof-findstaticassets.json",
  ...
  "MarkdownModelType": "/modules/model-types/db/ts-interfaces/markdownmodeltype.json",
  ...
  "NamedParameters<typeof getMergedQueryConfig>": "/modules/database/db/ts-interfaces/namedparameterstypeof-getmergedqueryconfig.json",
  ...
  "NamedParameters<typeof SearchBar>": "/modules/db-crud/db/ts-interfaces/namedparameterstypeof-searchbar.json",
  "NamedParameters<typeof shimmer>": "/modules/db-crud/db/ts-interfaces/namedparameterstypeof-shimmer.json",
  "NamedParameters<typeof SimplifiedSchemaFormDebug>": "/modules/db-crud/db/ts-interfaces/namedparameterstypeof-simplifiedschemaformdebug.json",
  ...
  "NamedParameters<typeof UpsertForm>": "/modules/db-crud/db/ts-interfaces/namedparameterstypeof-upsertform.json",
  ...
  "NamedParameters<typeof getDbModelMetadata>": "/modules/db-recipes/db/ts-interfaces/namedparameterstypeof-getdbmodelmetadata.json",
  ...
  "NamedParameters<typeof comparePassword>": "/modules/encrypt-password/db/ts-interfaces/namedparameterstypeof-comparepassword.json",
  "NamedParameters<typeof encryptPassword>": "/modules/encrypt-password/db/ts-interfaces/namedparameterstypeof-encryptpassword.json",
  ...
  "NamedParameters<typeof getFolderExplorationDetails>": "/modules/explore-project/db/ts-interfaces/namedparameterstypeof-getfolderexplorationdetails.json",
  ...
  "NamedParameters<typeof compressImage>": "/modules/ffmpeg-util/db/ts-interfaces/namedparameterstypeof-compressimage.json",
  ...
  "Group": "/modules/peer-types/db/ts-interfaces/group.json",
  ...
  "NamedParameters<typeof getTsFunction>": "/modules/function-functions-node/db/ts-interfaces/namedparameterstypeof-gettsfunction.json",
  "ApiFunction": "/modules/function-server-types/db/ts-interfaces/apifunction.json",
  ...
  "NamedParameters<typeof makeRelative>": "/modules/get-path/db/ts-interfaces/namedparameterstypeof-makerelative.json",
  ...
  "WatchEventType": "/modules/watch-types/db/ts-interfaces/watcheventtype.json",
  ...
  "NamedParameters<typeof Header>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-header.json",
  ...
  "MailDataFromOptional": "/modules/mail/db/ts-interfaces/maildatafromoptional.json",
  "NamedParameters<typeof sendMail>": "/modules/mail/db/ts-interfaces/namedparameterstypeof-sendmail.json",
  ...
  "GetStaticPropsContext": "/modules/markdown-reader-functions/db/ts-interfaces/getstaticpropscontext.json",
  "MarkdownCallToAction": "/modules/read-markdown-file/db/ts-interfaces/markdowncalltoaction.json",
  "NamedParameters<typeof copyStaticAssets>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-copystaticassets.json",
  "NamedParameters<typeof copyStaticAssetsCli>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-copystaticassetscli.json",
  "NamedParameters<typeof docsGetPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-docsgetpages.json",
  "NamedParameters<typeof docsGetStaticPaths>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-docsgetstaticpaths.json",
  "NamedParameters<typeof docsGetStaticProps>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-docsgetstaticprops.json",
  "NamedParameters<typeof getAllMarkdownReaderPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getallmarkdownreaderpages.json",
  "NamedParameters<typeof getChildren>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getchildren.json",
  "NamedParameters<typeof getFolderExplorationInfo>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getfolderexplorationinfo.json",
  "NamedParameters<typeof getMarkdownModelPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getmarkdownmodelpages.json",
  "NamedParameters<typeof getMarkdownPageInfo>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getmarkdownpageinfo.json",
  "NamedParameters<typeof getMarkdownReaderQueryPaths>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getmarkdownreaderquerypaths.json",
  "NamedParameters<typeof getOperationPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getoperationpages.json",
  "NamedParameters<typeof getPublicMarkdownFilePaths>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getpublicmarkdownfilepaths.json",
  "NamedParameters<typeof getReaderTodoPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-getreadertodopages.json",
  "NamedParameters<typeof markdownReaderGetStaticPaths>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-markdownreadergetstaticpaths.json",
  "NamedParameters<typeof markdownReaderGetStaticProps>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-markdownreadergetstaticprops.json",
  "NamedParameters<typeof markdownReaderGetStaticPropsFromPages>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-markdownreadergetstaticpropsfrompages.json",
  "NamedParameters<typeof removeExtensionsFromPath>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-removeextensionsfrompath.json",
  "NamedParameters<typeof removeNumberPrefix>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-removenumberprefix.json",
  "NamedParameters<typeof shouldExposeMarkdownFile>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-shouldexposemarkdownfile.json",
  "NamedParameters<typeof stripReadmeFromFolder>": "/modules/markdown-reader-functions/db/ts-interfaces/namedparameterstypeof-stripreadmefromfolder.json",
  ...
  "MarkdownReaderPageProps": "/modules/reader-ui/db/ts-interfaces/markdownreaderpageprops.json",
  "NestedWebPage": "/modules/webpage-types/db/ts-interfaces/nestedwebpage.json",
  "ReaderPageContentProps": "/modules/reader-ui/db/ts-interfaces/readerpagecontentprops.json",
  "ExtendedMarkdownProperties": "/modules/markdown-types/db/ts-interfaces/extendedmarkdownproperties.json",
  ...
  "WebMarkdownFile": "/modules/reader-ui/db/ts-interfaces/webmarkdownfile.json",
  "WebMarkdownProperties": "/modules/markdown-types/db/ts-interfaces/webmarkdownproperties.json",
  "WebsiteHeader": "/modules/markdown-types/db/ts-interfaces/websiteheader.json",
  "WebsiteHeaderProperties": "/modules/markdown-types/db/ts-interfaces/websiteheaderproperties.json",
  ...
  "AuthenticationMethod": "/modules/server-login/db/ts-interfaces/authenticationmethod.json",
  "AuthenticationMethodMethod": "/modules/server-login/db/ts-interfaces/authenticationmethodmethod.json",
  ...
  "NamedParameters<typeof getPrimaryPersona>": "/modules/persona-functions-node/db/ts-interfaces/namedparameterstypeof-getprimarypersona.json",
  ...
  "NamedParameters<typeof AugmentedWordComponent>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-augmentedwordcomponent.json",
  "NamedParameters<typeof Dictionary>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-dictionary.json",
  "NamedParameters<typeof DocsReaderLayout>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-docsreaderlayout.json",
  "NamedParameters<typeof Layout>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-layout.json",
  "NamedParameters<typeof ReaderPageContent>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-readerpagecontent.json",
  "NamedParameters<typeof ReaderPageHeader>": "/modules/reader-ui/db/ts-interfaces/namedparameterstypeof-readerpageheader.json",
  ...
  "NamedParameters<typeof addAuthenticationMethod>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-addauthenticationmethod.json",
  "NamedParameters<typeof addDeviceAuthenticationMethodConfirm>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-adddeviceauthenticationmethodconfirm.json",
  "NamedParameters<typeof addDeviceAuthenticationMethodWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-adddeviceauthenticationmethodwithcontext.json",
  "NamedParameters<typeof addPersonAuthenticationMethodWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-addpersonauthenticationmethodwithcontext.json",
  "NamedParameters<typeof findAuthenticatedPersonWithHandle>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-findauthenticatedpersonwithhandle.json",
  "NamedParameters<typeof findLoggedinPersonsWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-findloggedinpersonswithcontext.json",
  ...
  "NamedParameters<typeof loginWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-loginwithcontext.json",
  "NamedParameters<typeof loginWithPasswordWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-loginwithpasswordwithcontext.json",
  ...
  "NamedParameters<typeof removeDeviceAuthenticationMethodWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-removedeviceauthenticationmethodwithcontext.json",
  "NamedParameters<typeof removePersonAuthenticationMethodWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-removepersonauthenticationmethodwithcontext.json",
  "NamedParameters<typeof signupWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-signupwithcontext.json",
  "NamedParameters<typeof signupWithPasswordWithContext>": "/modules/server-login/db/ts-interfaces/namedparameterstypeof-signupwithpasswordwithcontext.json",
  ...
  "SignupPersonData": "/modules/server-login/db/ts-interfaces/signuppersondata.json",
  ...
  "NamedParameters<typeof useReferencableModelData>": "/modules/simplified-schema-form/db/ts-interfaces/namedparameterstypeof-usereferencablemodeldata.json",
  ...
  "NamedParameters<typeof sendSms>": "/modules/sms/db/ts-interfaces/namedparameterstypeof-sendsms.json",
  ...
  "NamedParameters<typeof getFileContents>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-getfilecontents.json",
  ...
  "NamedParameters<typeof moveFile>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-movefile.json",
  "NamedParameters<typeof newFile>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-newfile.json",
  "NamedParameters<typeof newFolder>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-newfolder.json",
  "NamedParameters<typeof processAssetUpload>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-processassetupload.json",
  "NamedParameters<typeof renameFilename>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-renamefilename.json",
  "NamedParameters<typeof saveFileContents>": "/modules/writer-functions/db/ts-interfaces/namedparameterstypeof-savefilecontents.json",
