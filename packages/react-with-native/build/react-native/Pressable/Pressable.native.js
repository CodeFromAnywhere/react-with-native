...
var Pressable = function (_a) {
    ...
    return (React.createElement(react_native_1.Pressable, __assign({ style: typeof style === "function" ? style : [tailwindStyle, style], onPress: onClick }, nativeWithoutStyle), (0, util_1.wrapInTextIfNeeded)(children, textClassName)));
};
