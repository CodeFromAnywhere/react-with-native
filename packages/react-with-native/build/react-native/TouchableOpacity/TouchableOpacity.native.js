...
var TouchableOpacity = function (_a) {
    ...
    return (React.createElement(react_native_1.TouchableOpacity, __assign({ style: [tailwindStyle, style], onPress: onClick }, nativeWithoutStyle), (0, util_1.wrapInTextIfNeeded)(children, textClassName)));
};
