...
var Text = function (_a) {
    var native = _a.native, className = _a.className, children = _a.children;
    ...
    return (React.createElement(react_native_1.Text, __assign({ style: [tailwindStyle, style] }, nativeWithoutStyle), children));
};
