...
var A = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.Pressable, __assign({ style: [style, tailwindStyle], onPress: function () { return href && react_native_1.Linking.openURL(href); } }, nativeWithoutStyle, { children: (0, util_1.wrapInTextIfNeeded)(children, textClassName) }), void 0));
};
exports.default = A;
