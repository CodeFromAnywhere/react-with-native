...
var A = function (_a) {
    ...
    return (React.createElement(react_native_1.Pressable, __assign({ style: [style, tailwindStyle], onPress: function () { return href && react_native_1.Linking.openURL(href); } }, nativeWithoutStyle), (0, util_1.wrapInTextIfNeeded)(children, textClassName)));
};
exports.default = A;
