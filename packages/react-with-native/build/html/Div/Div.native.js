...
var PureDiv = function (_a, ref) {
    var native = _a.native, textClassName = _a.textClassName, className = _a.className, children = _a.children, scrollable = _a.scrollable;
    ...
    if (scrollable) {
        return ((0, jsx_runtime_1.jsx)(react_native_1.ScrollView, __assign({ style: [tailwindStyle, style] }, nativeWithoutStyle, { ref: ref }, { children: (0, util_1.wrapInTextIfNeeded)(children, textClassName) })));
    }
