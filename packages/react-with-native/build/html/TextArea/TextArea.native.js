...
var TextArea = function (_a) {
    ...
    return (React.createElement(TextInput, __assign({ multiline: true, style: [{ textAlignVertical: "top" }, tailwindStyle, style] }, nativeWithoutStyle), wrapInTextIfNeeded(children, textClassName)));
};
