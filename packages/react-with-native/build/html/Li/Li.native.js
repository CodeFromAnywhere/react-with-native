...
var Li = function (_a) {
    ...
    return (React.createElement(react_native_1.View, __assign({ style: [tailwindStyle, style] }, nativeWithoutStyle), (0, util_1.wrapInTextIfNeeded)(children, textClassName)));
};
exports.default = Li;
