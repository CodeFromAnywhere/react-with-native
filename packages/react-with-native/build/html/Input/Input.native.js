...
var Input = function (_a) {
    ...
    return (React.createElement(react_native_1.TextInput, __assign({ style: [{ fontWeight: "bold" }, tailwindStyle, style] }, nativeWithoutStyle), nativeWithoutStyle.children || children));
};
