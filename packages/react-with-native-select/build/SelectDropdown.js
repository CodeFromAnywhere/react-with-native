...
var renderOption = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_with_native_2.Div, __assign({ className: "flex justify-between" }, { children: [(0, jsx_runtime_1.jsxs)(react_with_native_2.Div, __assign({ className: "flex items-center" }, { children: [(0, jsx_runtime_1.jsx)(react_with_native_2.Span, __assign({ className: classNames(selected || active ? "font-semibold text-primary" : "font-normal", "ml-3 block truncate") }, { children: item === null || item === void 0 ? void 0 : item.label })), Icon && (0, jsx_runtime_1.jsx)(Icon, {})] })), isHeader ? ((0, jsx_runtime_1.jsx)(react_with_native_2.Div, __assign({ className: "flex items-center justify-center w-6 h-6" }, { children: isOpen ? (0, jsx_runtime_1.jsx)(react_with_native_1.Svg, { src: AiFillCaretUp_svg_1.default }) : (0, jsx_runtime_1.jsx)(react_with_native_1.Svg, { src: AiFillCaretDown_svg_1.default }) }))) : ((0, jsx_runtime_1.jsx)(SelectedIcon_1.default, { selected: selected }))] })));
};
