...
export declare type ValueOrGetter<TInput extends PluginInputType> = ((oldValue: TInput["value"]) => TInput["value"]) | TInput["value"];
export declare type OnChange<TInput extends PluginInputType> = (value: ValueOrGetter<TInput>) => void;
