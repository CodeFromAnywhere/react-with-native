...
exports.setConfig =
  exports.errorOnField =
  exports.isObject =
  exports.Input =
  exports.DefaultInputContainer =
  exports.inputClass =
  exports.inputClassWithoutWidth =
  exports.makeInputField =
  exports.notEmpty =
  exports.deepEqual =
    void 0;
...
var sameFieldArray = function (arr1, arr2) {
  var simpleArr1 = arr1.map(function (_a) {
    var shouldHide = _a.shouldHide,
      titleFromState = _a.titleFromState,
      hasError = _a.hasError,
      item = __rest(_a, ["shouldHide", "titleFromState", "hasError"]);
    return item;
  });
              ...
              __assign(
                ...
                },
                {
                  children: sectionTitle
                    ? (0, jsx_runtime_1.jsx)(
                        react_with_native_1.P,
                        {
                          children: (0, jsx_runtime_1.jsx)(
                            react_with_native_1.Strong,
                            { children: sectionTitle },
                            void 0
                          ),
                        },
              ...
              children: [
                ...
                description &&
                  (0, jsx_runtime_1.jsx)(
                    react_with_native_1.Div,
                    __assign(
                      { className: "flex mx-3 mb-2 items-start " },
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          react_with_native_1.P,
                          __assign(
                ...
                error
                  ? (0, jsx_runtime_1.jsx)(
                      ...
                      __assign(
                        {
                          className: errorClassName || "mr-3 mb-2 text-red-500",
                        },
                        { children: error || "Invalid value" }
                      ),
                      void 0
                    )
                  : null,
...
var getPlugin = function (type, plugins) {
  return type ? plugins[type] : plugins[Object.keys(plugins)[0]];
};
var Input = function (_a) {
  ...
  var type = _a.type,
    ...
    description = _a.description,
    config = _a.config,
    uniqueFieldId = _a.uniqueFieldId,
    renderInputContainer = _a.renderInputContainer,
    errorClassName = _a.errorClassName,
              ...
              error:
                ...
                ((_b =
                  errors === null || errors === void 0
                    ? void 0
                    : errors.find((0, exports.errorOnField)(fieldName))) ===
                  null || _b === void 0
                  ? void 0
                  : _b.message),
              extra: extra,
            ...
            children: [
              backButton &&
                (0, jsx_runtime_1.jsx)(
                  react_with_native_1.Div,
                  __assign(
                    { onClick: backButton, className: "p-4 cursor-pointer" },
                    { children: "back" }
                  ),
                  void 0
                ),
              (0, jsx_runtime_1.jsx)(
                react_with_native_1.H2,
                __assign(
...
var errorOnField = function (fieldName) {
...
var DataForm = function (_a) {
  ...
  var fields = _a.fields,
    ...
    withSubmitProps = _a.withSubmitProps,
    noSubmit = _a.noSubmit,
    submitButtonText = _a.submitButtonText,
    submitButtonColor = _a.submitButtonColor,
    title = _a.title,
    backButton = _a.backButton,
    plugins = _a.plugins,
    renderSubmitComponent = _a.renderSubmitComponent,
    renderInputContainer = _a.renderInputContainer,
    stickySubmit = _a.stickySubmit,
    renderTitle = _a.renderTitle,
    submitClassName = _a.submitClassName,
    errorClassName = _a.errorClassName,
    successClassName = _a.successClassName;
  ...
  var id = (0, react_1.useState)(
    "Form".concat(String(Math.round(Math.random() * 1000000)))
  )[0];
  var _d = (0, react_1.useState)([]),
    fieldsWithReferences = _d[0],
    setFieldsWithReferences = _d[1];
  // need to have because we want to see when it's changed
  var _e = (0, react_1.useState)([]),
    fieldsWithoutReferences = _e[0],
    setFieldsWithoutReferences = _e[1];
  (0, react_1.useEffect)(
    function () {
      var fieldsWithoutReferencesLocal = fields.map(function (f) {
        return f();
      });
      if (
        ...
        setFieldsWithReferences(
          fieldsWithoutReferencesLocal.map(function (fieldWithoutReference) {
            return __assign(__assign({}, fieldWithoutReference), {
              reference: (0, react_1.createRef)(),
            });
          })
        );
  ...
  var initialState = __assign(
    __assign({}, initialValuesPartial),
    initialValues
  );
  var _f = (0, react_1.useState)(initialState),
    state = _f[0],
    setState = _f[1];
  //used to check if the initialValues have changed
  var _g = (0, react_1.useState)(),
    initialValuesState = _g[0],
    setInitialValuesState = _g[1];
  (0, react_1.useEffect)(
    function () {
      if (
        !initialValuesState ||
        !(0, react_2.default)(initialState, initialValuesState)
      ) {
  ...
  var _k = (0, react_1.useState)(),
    success = _k[0],
    setSuccess = _k[1];
  var notReadyFields = fieldsWithReferences.filter(function (x) {
    var _a, _b;
    return (
      !((_a = x.shouldHide) === null || _a === void 0
        ? void 0
        : _a.call(x, state)) &&
      ((_b = x.hasError) === null || _b === void 0
        ? void 0
        : _b.call(x, state[x.field], state))
    );
  });
  var setErrorsReject = function (stringOrErrorArray) {
    ...
    if (stringOrErrorArray) {
      ...
      var newErrors_1 =
        typeof stringOrErrorArray === "string"
          ...
          : stringOrErrorArray.map(function (_a) {
              var propertyPath = _a.propertyPath,
                message = _a.message;
              return {
                message: message,
                propertyPath: fields
                  ...
                  .find(function (x) {
                    return (
                      propertyPath === x ||
                      propertyPath.startsWith("".concat(x, "."))
                    );
                  })
                  ? propertyPath
      ...
      var firstNotReadyField = fieldsWithReferences.filter(function (x) {
        return (
          newErrors_1.find((0, exports.errorOnField)(x.field)) !== undefined
        );
      })[0];
      if (isWeb) {
        var top_1 =
          (((_c =
            (_b =
              (_a =
                firstNotReadyField === null || firstNotReadyField === void 0
                  ? void 0
                  : firstNotReadyField.reference) === null || _a === void 0
                ? void 0
        ...
        (_d = window.scrollTo) === null || _d === void 0
          ? void 0
          : _d.call(window, {
              top: top_1,
              behavior: "smooth",
  ...
  var firstErrorRef =
    (_c =
      (_b = notReadyFields[0]) === null || _b === void 0
        ? void 0
        : _b.reference) === null || _c === void 0
      ? void 0
      : _c.current;
  function onClickSubmit(state) {
    ...
    var frontendErrorArray = fields.reduce(function (all, field) {
      var _a, _b, _c, _d;
      var shouldNotHide = !((_b = (_a = field()).shouldHide) === null ||
      _b === void 0
        ? void 0
        : _b.call(_a, state));
      var errorMessage =
        (_d = (_c = field()).hasError) === null || _d === void 0
          ? void 0
          : _d.call(_c, state[field().field], state);
    ...
    //
    if (
      (frontendErrorArray === null || frontendErrorArray === void 0
        ? void 0
        : frontendErrorArray.length) === 0
    ) {
      //no errors
      setLoading(true);
      onSubmit(
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      withSubmitProps === null || withSubmitProps === void 0
        ? void 0
          ...
          __assign(
            ...
            },
            {
              children: [
                loading
                  ? (0, jsx_runtime_1.jsx)(
                      ...
                      __assign(
                        ...
                        {
                          children: (0, jsx_runtime_1.jsx)(
                            react_with_native_1.ActivityIndicator,
                            {},
                            void 0
                          ),
                        }
                ...
                (0, jsx_runtime_1.jsx)(
                  react_with_native_1.Div,
                  { children: submitButtonText || "Save Data" },
                  void 0
                ),
              ],
            }
  ...
  var globalError =
    errors === null || errors === void 0
      ? void 0
      : errors.find(function (x) {
          return x.propertyPath === GLOBAL_PROPERTY_PATH;
        });
  return (0, jsx_runtime_1.jsxs)(
    react_with_native_1.Form,
    __assign(
      {
        className: "w-full",
        onSubmit: function (e) {
            ...
            __assign(
              { className: "w-full" },
              {
                children: [
                  (0, jsx_runtime_1.jsx)(
                    Title,
                    { title: title, backButton: backButton },
                    void 0
                  ),
                  success
                    ? (0, jsx_runtime_1.jsx)(
                  ...
                  globalError
                    ? (0, jsx_runtime_1.jsx)(
                        react_with_native_1.P,
                        __assign(
                          { className: errorClassName || "text-red-600" },
                  ...
                  fieldsWithReferences.map(function (field, index) {
                    ...
                    var next =
                      (_a = fields[index + 1]) === null || _a === void 0
                        ? void 0
                        : _a.call(fields);
                    var onChange = function (state) {
                      return function (newValueOrGetter) {
                        var _a;
                        var _b;
                        var newValue =
                          typeof newValueOrGetter === "function"
                            ...
                            : newValueOrGetter;
                        var newState =
                          ((_a = {}), (_a[field.field] = newValue), _a);
                        var newFullState = __assign(
                          __assign({}, state),
                          newState
                        );
                        var fieldErrors = errors.filter(
                          (0, exports.errorOnField)(field.field)
                        );
                        //check if field still has error(s)
                        var newFieldErrors =
                          (_b = field.hasError) === null || _b === void 0
                            ? void 0
                            : _b.call(field, newValue, newFullState);
                        var newFieldErrorsAmount =
                        ...
                        if (
                          ...
                          var newErrors = errors.filter(function (error) {
                            return !(0, exports.errorOnField)(field.field)(
                              error
                            );
                          });
                          var newFieldErrorsArray =
                            typeof newFieldErrors === "string"
                              ? [
                                  {
                                    message: newFieldErrors,
                        ...
                        withSubmitProps === null || withSubmitProps === void 0
                          ? void 0
                          : withSubmitProps(
                              __assign(__assign({}, submitProps), {
                                state: newFullState,
                                onSubmit: function () {
                                  return onClickSubmit(newFullState);
                                },
                              })
                            );
                      };
                    ...
                    return (
                      (_b = field.shouldHide) === null || _b === void 0
                        ? void 0
                        : _b.call(field, state)
                    )
                      ? null
          ...
          Submit
            ? (0, jsx_runtime_1.jsx)(
                ...
                __assign(
                  {
                    className: ""
                      .concat(stickySubmit ? "sticky bottom-0" : "", " ")
                      .concat(submitClassName || "mb-2 py-2"),
                  },
                  { children: (0, jsx_runtime_1.jsx)(Submit, {}, void 0) }
                ),
                void 0
              )
            : null,
