...
var TimeInput = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(rc_time_picker_1.default, { value: (0, moment_1.default)(value), onChange: function (time) { return onChange(time); }, showSecond: false, format: "h:mm a", use12Hours: true, className: src_1.inputClass }));
};
