 ...
 */
var useCustomUrl = function (queryKey, config) {
                ...
                case 0:
                    stringified = newValue === undefined
                        ...
                        : Array.isArray(newValue)
                            ...
                            : [String(newValue)];
                    queryPart = stringified === undefined ? "" : getQueryPart(stringified, queryKey);
                    ...
                    newQueryString = allKeys.reduce(function (queryString, key) {
                        ...
                        if (router.query[key]) {
                            var queryPart_1 = getQueryPart((0, js_util_1.makeArray)(router.query[key]), key);
...
exports.useCustomUrl = useCustomUrl;
//# sourceMappingURL=useCustomUrl.js.map