...
exports.TsInterfaceComponent = void 0;
...
var TsInterfaceComponent = function (_a) {
    var 
    // the main info
    ...
    if (isDbModel) {
        interfaceButtons.push({
            ...
            title: "Show data",
            onClick: function () {
                router.push("db?model=".concat(name));
            },
        });
    }
...
exports.TsInterfaceComponent = TsInterfaceComponent;
//# sourceMappingURL=TsInterfaceComponent.js.map