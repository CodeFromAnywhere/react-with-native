...
(0,log_1.log)("I don't support this usecase (type is an array of multiple types)... ".concat(r.type.join(",")),{type:"debug"});var t=Array.isArray(r.type)?r.type[0]:r.type,s=e?n.concat(e):n,a=(0,getRefLink_1.getRefLink)(r.$ref),o=!!a&&n.includes(a);if(a&&!o){var m=i.find((function(e){return e.name===a}));m||(0,log_1.log)("Strange, ref was not present in the possible refs",{type:"debug"},{possibleRefNames:i.map((function(e){return e.name})),refName:a});var _=r.description?"".concat(r.description,"\n\n"):"",c=(null==m?void 0:m.schema)?__assign(__assign({},m.schema),{description:"".concat(_).concat(m.schema.description||"")}):void 0;return c?(0,exports.simplifySchema)(a,c,i,s):void 0}var u=r.description,f=(0,findFirstCommentTypes_1.findFirstCommentTypes)(u),p=__assign({enum:r.enum,circularRefName:a,fullComment:u},f);if("boolean"===t)return __assign(__assign({},p),{type:"boolean"});if("integer"===t||"number"===t)
// NB: integers are also numbers
return __assign(__assign({},p),{type:"number"});if("null"===t)return __assign(__assign({},p),{type:"null"});if("string"===t)return __assign(__assign({},p),{type:"string"});if("array"===t){var l=(0,schema_util_1.getSchemaItems)(r).map((function(r){var t=(0,getRefLink_1.getRefLink)(r.$ref)||null,s=(0,exports.simplifySchema)(t,r,i,e?n.concat(e):n);if(s)return{schema:s,name:t}})).filter(js_util_1.notEmpty);return __assign(__assign({},p),{items:l,type:"array"})}
...
if(!!!g.find((function(e){return n.includes(e.name)})))return{name:e.name,required:e.required,schema:r}}})).filter(js_util_1.notEmpty);return __assign(__assign({},p),{properties:y,type:"object"})};exports.simplifySchema=simplifySchema;
