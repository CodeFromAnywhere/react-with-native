...
var LabeledButton = function (button, index) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Button, __assign({ className: "flex flex-col items-center", onClick: button.onClick }, { children: [(0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: "w-10 ".concat(button.isActive ? "bg-blue-900 dark:bg-blue-600 rounded-full" : "") }, { children: button.icon ? ((0, jsx_runtime_1.jsx)(react_with_native_1.Svg, { src: button.icon, width: size, height: size })) : button.emoji ? ((0, jsx_runtime_1.jsx)(react_with_native_1.P, __assign({ className: "".concat(textSizeClass, " hover:scale-110") }, { children: button.emoji }))) : button.component ? ((0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: heightClass }, { children: button.component() }))) : null })), button.size === "small" ? null : ((0, jsx_runtime_1.jsx)(react_with_native_1.P, __assign({ className: "text-xs" }, { children: button.title })))] }), "labeledbutton".concat(index)));
};
