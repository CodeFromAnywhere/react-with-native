...
bundleConfig, config) { return __awaiter(void 0, void 0, void 0, function () {
    var manualProjectRoot, projectRoot, yarnInstallAfter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, generateFunctionSdks_1.generateFunctionSdks)({
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, generateEnvSdks_1.generateEnvSdks)(bundleConfig, {
                        manualProjectRoot: manualProjectRoot,
                        skipYarnInstall: yarnInstallAfter,
                    })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, (0, generateDbSdk_1.generateDbSdk)({ manualProjectRoot: manualProjectRoot, skipYarnInstall: yarnInstallAfter })];
            case 4:
                _a.sent();
                if (yarnInstallAfter) {
                    (0, child_process_1.spawnSync)("yarn --prefer-offline", {
                        cwd: projectRoot,
                        encoding: "utf8",
                        stdio: "inherit",
                        shell: true,
