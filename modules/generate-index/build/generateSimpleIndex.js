...
exports.generateSimpleIndex = void 0;
 ...
 */
var generateSimpleIndex = function (_a) {
    var operationName = _a.operationName, manualProjectRoot = _a.manualProjectRoot;
    return __awaiter(void 0, void 0, void 0, function () {
        var operationBasePath, classification, outputPath, files, srcRelativeFileIds, indexationString;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    classification = (0, get_path_1.getOperationClassification)(operationBasePath);
                    if (classification === "ui-web") {
                        (0, log_1.log)("Not generating index.ts for next.js project, not needed.", {
                            type: "default",
                        });
                        return [2 /*return*/];
                    }
