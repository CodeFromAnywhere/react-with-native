...
exports.generateOperationIndex = exports.mapToImportStatement = void 0;
...
var mapToImportStatement = function (item, type, operationBasePath) {
    var srcRelativeFileId = (0, get_path_1.getSrcRelativeFileId)(item.operationRelativeTypescriptFilePath, operationBasePath);
 ...
 */
var generateOperationIndex = function (_a) {
    var operationName = _a.operationName, manualProjectRoot = _a.manualProjectRoot;
    return __awaiter(void 0, void 0, void 0, function () {
        var operationBasePath, outputPath, functionArray, variableArray, interfacesArray, importStatements, files;
            ...
            switch (_b.label) {
                ...
                case 2:
                    functionArray = (_b.sent())
                        ...
                        .map(function (item) { return (0, exports.mapToImportStatement)(item, "function", operationBasePath); });
                ...
                case 3:
                    variableArray = (_b.sent())
                        ...
                        .map(function (item) { return (0, exports.mapToImportStatement)(item, "variable", operationBasePath); });
                ...
                case 4:
                    interfacesArray = (_b.sent())
                        ...
                        .map(function (item) { return (0, exports.mapToImportStatement)(item, "interface", operationBasePath); });
                ...
                case 6:
                    _b.sent();
                    console.log("generated operation index.ts file");
                    return [2 /*return*/, outputPath];
            }
        });
    });
};
exports.generateOperationIndex = generateOperationIndex;
//# sourceMappingURL=generateOperationIndex.js.map