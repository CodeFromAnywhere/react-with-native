 ...
 */
var oneByOne = function (array, callback) { return __awaiter(void 0, void 0, void 0, function () {
    var getResults, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                getResults = function (results, instance, index) { return __awaiter(void 0, void 0, void 0, function () {
                    var awaitedResults, result, newResults;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, results];
                            case 1:
                                awaitedResults = _a.sent();
                                return [4 /*yield*/, callback(instance, index)];
                            case 2:
                                result = _a.sent();
                                newResults = __spreadArray(__spreadArray([], awaitedResults, true), [result], false);
