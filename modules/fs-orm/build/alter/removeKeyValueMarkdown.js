...
// Base case
var r=e.find((function(e){return e.slug===t}));
// console.log({ foundItem, storedData, slug });
if(!r)return{newStoredData:e,amountRemoved:0,message:"slug not found",isSuccesful:!0};if(r.isHeaderCalculated){
...
var s=e.filter((function(e){return e.slug!==r.slug}));return{newStoredData:s,isSuccesful:!0,amountRemoved:e.length-s.length,message:"Removed item where item has more items in its category"}}
