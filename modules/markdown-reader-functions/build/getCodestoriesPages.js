...
exports.getCodestoriesPages = void 0;
var get_path_1 = require("get-path");
var js_util_1 = require("js-util");
var explore_project_1 = require("explore-project");
var getMarkdownReaderPages_1 = require("./getMarkdownReaderPages");
var getCodestoriesPages = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log({ codestoriesPaths: codestoriesPaths });
                return [4 /*yield*/, (0, getMarkdownReaderPages_1.getMarkdownReaderPages)({
                        projectRoot: projectRoot,
                        basePaths: codestoriesPaths,
                        mapQueryPath: function (queryPath) {
                            return queryPath.replace("codestories/", "");
                        },
                    })];
            case 2:
                pages = _a.sent();
...
exports.getCodestoriesPages = getCodestoriesPages;
//# sourceMappingURL=getCodestoriesPages.js.map