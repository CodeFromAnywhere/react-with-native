...
var upsert = function () { return __awaiter(void 0, void 0, void 0, function () {
    var item, x;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                item = {
                    categoryStackCalculated: ["hello", "world"],
                    name: "hell-yeah",
                    markdown: "some other markdown....",
                };
                return [4 /*yield*/, test_db_1.testDb.upsert("MarkdownTestModel", item)];
            case 2:
                x = _a.sent();
                console.log({ x: x });
                return [2 /*return*/];
...
var get = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, upsert()];
            case 1:
                _a.sent();
                return [4 /*yield*/, test_db_1.testDb.get("MarkdownTestModel")];
            case 2:
                items = _a.sent();
                console.dir({ items: items }, { depth: 99 });
                return [2 /*return*/];
        }
    });
}); };
get();
//# sourceMappingURL=setNestedFiles.test.js.map