...
var generateKvmdInstance = function () {
    return {
        ...
        categoryStack: ["Header1", "Subheader"],
        comment: "comment",
        value: "value",
        name: "Key",
        slug: "key-slug",
...
var testKvmd = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                firstInstance = generateKvmdInstance();
                firstId = firstInstance.id;
                return [4 /*yield*/, test_db_1.testDb.set("KeyValueMarkdownTestModel", [
                        firstInstance,
                    ])];
            case 1:
                setResult = _c.sent();
                console.log({ setResult: setResult });
                return [4 /*yield*/, test_db_1.testDb.get("KeyValueMarkdownTestModel")];
            case 2:
                getResult = _c.sent();
                ...
                return [4 /*yield*/, test_db_1.testDb.push("KeyValueMarkdownTestModel", generateKvmdInstance())];
            case 3:
                pushResult = _c.sent();
            ...
            case 4:
                ...
                return [4 /*yield*/, test_db_1.testDb.remove("KeyValueMarkdownTestModel", function (content) { return content.id !== firstId; })];
            case 5:
            ...
            case 6:
                ...
                return [4 /*yield*/, test_db_1.testDb.update("KeyValueMarkdownTestModel", function (content) { return content.id === firstId; }, function (content) {
...
exports.testKvmd = testKvmd;
//# sourceMappingURL=test-kvmd.js.map