...
var testJsonSingle = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                firstInstance = generateJsonSingleInstance();
                firstId = firstInstance.id;
                return [4 /*yield*/, test_db_1.testDb.set("DefaultTestModel", [firstInstance])];
            case 1:
                setResult = _c.sent();
                console.log({ setResult: setResult });
                return [4 /*yield*/, test_db_1.testDb.get("DefaultTestModel")];
            case 2:
                getResult = _c.sent();
                ...
                return [4 /*yield*/, test_db_1.testDb.push("DefaultTestModel", generateJsonSingleInstance())];
            case 3:
                pushResult = _c.sent();
            ...
            case 4:
                ...
                return [4 /*yield*/, test_db_1.testDb.remove("DefaultTestModel", function (content) { return content.id !== firstId; })];
            case 5:
            ...
            case 6:
                ...
                return [4 /*yield*/, test_db_1.testDb.update("DefaultTestModel", function (content) { return content.id === firstId; }, function (content) {
                        return __assign(__assign({}, content), { name: newValue });
                    })];
            case 7:
                ...
                if (((_a = updateResult.data) === null || _a === void 0 ? void 0 : _a[0].name) !== newValue) {
            ...
            case 8:
                ...
                console.log("JsonSingle Test Succeeded!");
                return [2 /*return*/, true];
        }
    });
}); };
exports.testJsonSingle = testJsonSingle;
//# sourceMappingURL=test-json-single.js.map