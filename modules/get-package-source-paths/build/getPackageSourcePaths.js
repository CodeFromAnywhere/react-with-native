...
exports.getPackageSourcePaths = void 0;
 ...
 */
var getPackageSourcePaths = function (_a) {
    var operationBasePath = _a.operationBasePath, ignoreIndexFiles = _a.ignoreIndexFiles, allTypes = _a.allTypes;
    return __awaiter(void 0, void 0, void 0, function () {
        var filePaths;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, k_explore_1.explore)({
                        basePath: fs_util_1.path.join(operationBasePath, "src"),
...
exports.getPackageSourcePaths = getPackageSourcePaths;
