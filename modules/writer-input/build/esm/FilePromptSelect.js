...
export var FilePromptSelect = function (props) {
    var items = props.items, contextContent = props.contextContent, projectRelativeFilePath = props.projectRelativeFilePath;
    var lastSelection = useLastSelection();
    var promptResultAlert = usePromptResultAlert();
    var alert = useAlert();
            ...
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api.processChatGptPrompt({
                            ...
                            selectionContent: lastSelection,
                            commentContent: null,
                ...
                case 1:
                    apiResult = _e.sent();
                    promptResultAlert(prompt.name, ((_b = (_a = apiResult === null || apiResult === void 0 ? void 0 : apiResult.result) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b.text) || "No textual result", (_d = (_c = apiResult === null || apiResult === void 0 ? void 0 : apiResult.result) === null || _c === void 0 ? void 0 : _c.result) === null || _d === void 0 ? void 0 : _d.thread, projectRelativeFilePath);
                    setValue(null);
                    return [2 /*return*/];
            }
        });
