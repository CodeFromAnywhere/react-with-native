 ...
 */
var readMarkdownFile = function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var pathParse, isMarkdownFile, readable, fileString, fileName, markdownParse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (!fileString)
                    return [2 /*return*/, null];
                fileName = fs_util_1.path.parse(filePath).name;
                markdownParse = (0, markdown_parse_js_1.mdToJsonParse)(fileString, fileName);
