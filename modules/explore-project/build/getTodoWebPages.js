...
exports.getTodoWebPages = void 0;
 ...
 */
var getTodoWebPages = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var earliestUpdatedAt, todoQueryPaths, todoPages;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                earliestUpdatedAt = (0, js_util_1.destructureOptionalObject)(config).earliestUpdatedAt;
            ...
            case 1:
                todoQueryPaths = _a.sent();
                todoPages = (todoQueryPaths === null || todoQueryPaths === void 0 ? void 0 : todoQueryPaths.map(function (queryPath) {
                    var _a = queryPath.split("/todo/"), before = _a[0], after = _a[1];
                     ...
                     */
                    var menuTitle = "".concat((0, convert_case_1.humanCase)(fileName), " (50% done, 5/10)");
                    /**
                     * Idea: showing an emoji for the code-owner or the status of the todo-offers
                     */
                    var menuTitleAugmentation = "🧙‍♂️";
                    /**
                    ...
                    var page = {
                        extraData: {
                            projectRelativeFilePath: "".concat(lastFolderBeforeTodo, "/").concat(todoRelativeFileId),
                        },
                        queryPath: queryPath,
                        menuTitle: menuTitle,
                ...
                return [2 /*return*/, todoPages];
        }
    });
}); };
exports.getTodoWebPages = getTodoWebPages;
//# sourceMappingURL=getTodoWebPages.js.map