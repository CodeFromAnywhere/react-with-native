...
// node packages
var path_1=__importDefault(require("path")),graceful_fs_1=require("graceful-fs"),js_util_1=require("js-util"),parseMd_1=require("./parseMd"),files_1=require("./files"),importFromFiles=function(e){var r=e.files,t=e.importStrategy,i=void 0===t?"default":t,s=e.list,n=e.guard;return r.map((function(e){var r=require(e);if("default"===i)return r.default||r;if("fileName"===i){var t=(0,files_1.withoutExtension)(e.split("/").pop());return r[t]}return"list"===i?s?(0,exports.mergeObjectsArray)(s.map((function(e){var t;return(t={})[e]=r[e],t}))):{}:void 0})).filter((function(e){return n?n(e)&&e:e}))};
// external packages
 ...
 */
var findFilesRecursively=function(e){var r=e.match,t=e.basePath,i=e.relativePath,s=e.onlyInSubFolders,n=e.onlyInCurrentFolder,a=i?path_1.default.join(t,i):t;return(0,graceful_fs_1.readdirSync)(a,{withFileTypes:!0}).reduce((function(e,l){if(l.isDirectory()&&!n){var o=l,u=(0,exports.findFilesRecursively)({basePath:t,relativePath:i?"".concat(i,"/").concat(o.name):o.name,match:r,onlyInSubFolders:!1});return e.concat(u)}if(!s){var f=l,d=path_1.default.join(a,f.name);return r((0,files_1.withoutExtension)(f.name),path_1.default.parse(f.name).ext)?e.concat([{relativeFolder:i,path:d}]):e}return e}),[])};exports.findFilesRecursively=findFilesRecursively;
